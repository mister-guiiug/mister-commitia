...
| E6 CI/CD | ✅ | Clients GitHub Actions & Azure DevOps Builds (pagination, continuation token, 429/Retry-After), inventaire avec leases, politique + **simulation obligatoire**, suppression unitaire à double confirmation, **suppression en masse** (throttling, reprise sur checkpoint, annulable), revérification des leases avant tout DELETE ; PR ouvertes détectées (push assisté) |
